...
func StreamDomainNameQuery(readCtx context.Context, metadata *fadaixiaozi.InboundContext, reader io.Reader) error {
	var length uint16
...
func DomainNameQuery(ctx context.Context, metadata *fadaixiaozi.InboundContext, packet []byte) error {
	var msg mDNS.Msg
