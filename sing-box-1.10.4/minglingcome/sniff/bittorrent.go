...
func BitTorrent(_ context.Context, metadata *fadaixiaozi.InboundContext, reader io.Reader) error {
	var first byte
...
func UTP(_ context.Context, metadata *fadaixiaozi.InboundContext, packet []byte) error {
...
func UDPTracker(_ context.Context, metadata *fadaixiaozi.InboundContext, packet []byte) error {
