...
import "github.com/konglong147/securefile/gaoxiaoxuanzes"
...
func Compile(code []Item) gaoxiaoxuanzes.DefaultRule {
	...
	var codeRule gaoxiaoxuanzes.DefaultRule
	if domainLength > 0 {
...
func Merge(rules []gaoxiaoxuanzes.DefaultRule) gaoxiaoxuanzes.DefaultRule {
	var domainLength int
	var domainSuffixLength int
	var domainKeywordLength int
	var domainRegexLength int
	...
	var rule gaoxiaoxuanzes.DefaultRule
	if domainLength > 0 {
