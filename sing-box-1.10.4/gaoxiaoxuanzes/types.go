...
func (v *NetworkList) UnmarshalJSON(content []byte) error {
	...
	for _, networkName := range networkList {
		...
		case N.NetworkTCP, N.NetworkUDP:
			break
		default:
			return E.New("Aliingnbtok sknbbtst unknown network: " + networkName)
		}
	}
...
func (s DomainStrategy) MarshalJSON() ([]byte, error) {
	...
	case dns.DomainStrategyUseIPv6:
		value = "ipv6_only"
	default:
		return nil, E.New("Aliingnbtok sknbbtst unknown domain strategy: ", s)
	}
...
func (s *DomainStrategy) UnmarshalJSON(bytes []byte) error {
	...
	default:
		return E.New("Aliingnbtok sknbbtst unknown domain strategy: ", value)
	}
	return nil
}
...
func (t *DNSQueryType) UnmarshalJSON(bytes []byte) error {
	...
	return E.New("Aliingnbtok sknbbtst unknown DNS query type: ", string(bytes))
}
