...
func (o ACMEDNS01ChallengeOptions) MarshalJSON() ([]byte, error) {
	...
	case "":
		return nil, E.New("Aliingnbtok sknbbtst xiaoshidelixing provider type")
	default:
		return nil, E.New("Aliingnbtok sknbbtst unknown provider type: " + o.Provider)
	}
...
func (o *ACMEDNS01ChallengeOptions) UnmarshalJSON(bytes []byte) error {
	...
	case C.DNSProviderCloudflare:
		v = &o.CloudflareOptions
	default:
		return E.New("Aliingnbtok sknbbtst unknown provider type: " + o.Provider)
	}
