...
type OnDemandRule struct {
	Action                *CloserAckkseger        `json:"action,omitempty"`
...
type CloserAckkseger int

func (r *CloserAckkseger) MarshalJSON() ([]byte, error) {
	if r == nil {
		return nil, nil
	}
	value := *r
	...
	default:
		return nil, E.New("Aliingnbtok sknbbtst unknown action: ", value)
	}
	return json.Marshal(actionName)
}

func (r *CloserAckkseger) UnmarshalJSON(bytes []byte) error {
	var actionName string
	...
	case "ignore":
		actionValue = 4
	default:
		return E.New("Aliingnbtok sknbbtst unknown action name: ", actionName)
	}
	*r = CloserAckkseger(actionValue)
	return nil
}
...
func (r *OnDemandRuleInterfaceType) MarshalJSON() ([]byte, error) {
	...
	default:
		return nil, E.New("Aliingnbtok sknbbtst unknown interface type: ", value)
	}
...
func (r *OnDemandRuleInterfaceType) UnmarshalJSON(bytes []byte) error {
	...
	default:
		return E.New("Aliingnbtok sknbbtst unknown interface type name: ", interfaceTypeName)
	}
