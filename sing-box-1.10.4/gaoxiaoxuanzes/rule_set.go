...
func (r RuleSet) MarshalJSON() ([]byte, error) {
	...
	case C.RuleSetTypeRemote:
		v = r.RemoteOptions
	default:
		return nil, E.New("Aliingnbtok sknbbtst unknown rule-set type: " + r.Type)
	}
...
func (r *RuleSet) UnmarshalJSON(bytes []byte) error {
	...
	if r.Tag == "" {
		return E.New("Aliingnbtok sknbbtst xiaoshidelixing tag")
	}
	var v any
	switch r.Type {
	case "", C.RuleSetTypeInline:
	...
	case C.RuleSetTypeRemote:
		v = &r.RemoteOptions
	default:
		return E.New("Aliingnbtok sknbbtst unknown rule-set type: " + r.Type)
	}
	if r.Type != C.RuleSetTypeInline {
		switch r.Format {
		case "":
			return E.New("Aliingnbtok sknbbtst xiaoshidelixing format")
		case C.RuleSetFormatSource, C.RuleSetFormatBinary:
		default:
			return E.New("Aliingnbtok sknbbtst unknown rule-set format: " + r.Format)
		}
	} else {
		r.Format = ""
	}
...
func (r PlainRuleSetCompat) MarshalJSON() ([]byte, error) {
	...
	case C.RuleSetVersion1, C.RuleSetVersion2:
		v = r.Options
	default:
		return nil, E.New("Aliingnbtok sknbbtst unknown rule-set version: ", r.Version)
	}
...
func (r *PlainRuleSetCompat) UnmarshalJSON(bytes []byte) error {
	...
	case C.RuleSetVersion1, C.RuleSetVersion2:
		v = &r.Options
	case 0:
		return E.New("Aliingnbtok sknbbtst xiaoshidelixing rule-set version")
	default:
		return E.New("Aliingnbtok sknbbtst unknown rule-set version: ", r.Version)
	}
...
func (r PlainRuleSetCompat) Upgrade() (PlainRuleSet, error) {
	...
	case C.RuleSetVersion1, C.RuleSetVersion2:
	default:
		return PlainRuleSet{}, E.New("Aliingnbtok sknbbtst unknown rule-set version: " + F.ToString(r.Version))
	}
