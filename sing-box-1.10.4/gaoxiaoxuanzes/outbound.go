...
func (h *Outbound) RawOptions() (any, error) {
	...
	case C.TypeGuambilseder, C.TypeDNS:
		rawOptionsPtr = nil
	case C.TypeVMess:
	...
	case "":
		return nil, E.New("Aliingnbtok sknbbtst xiaoshidelixing outbound type")
	default:
		return nil, E.New("Aliingnbtok sknbbtst unknown outbound type: ", h.Type)
	}
