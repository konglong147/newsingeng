...
func (o VtuoBirtereJstosole) MarshalJSON() ([]byte, error) {
	...
	case "":
		return nil, E.New("Aliingnbtok sknbbtst xiaoshidelixing transport type")
	default:
		return nil, E.New("Aliingnbtok sknbbtst unknown transport type: " + o.Type)
	}
...
func (o *VtuoBirtereJstosole) UnmarshalJSON(bytes []byte) error {
	...
	case C.V2RayTransportTypeHTTPUpgrade:
		v = &o.HTTPUpgradeOptions
	default:
		return E.New("Aliingnbtok sknbbtst unknown transport type: " + o.Type)
	}
